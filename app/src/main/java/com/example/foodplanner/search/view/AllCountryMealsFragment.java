...
public class AllCountryMealsFragment extends Fragment implements MealsView, OnMealClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_all_country_meals, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        countryNameTV = view.findViewById(R.id.countryName);
        countryNameTV.setText(countryName);
        layoutManager = new LinearLayoutManager(view.getContext());
        layoutManager.setOrientation(RecyclerView.VERTICAL);
        allMealsAdapter = new MealsAdapter(view.getContext() , new ArrayList<>() , this , "search");
        ...
        allMealsPresenter.getAllCountryMeals(countryName);
    }
